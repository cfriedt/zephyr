...
/* Hash bits were previously a constant 12 */
...
/* Max offset of the match to look for, inclusive. Previously a constant 32768 */
...
unsigned int approx_compressed_len;
...
void copy(void *data, unsigned int offset, unsigned int len)
{
	printf("C-%u,%u\n", offset, len);
...
static inline void copy(void *data, unsigned int offset, unsigned int len)
{
...
void uzlib_compress(struct uzlib_comp *data, const uint8_t *src, unsigned int slen)
{
