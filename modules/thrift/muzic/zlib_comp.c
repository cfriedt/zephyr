 ...
 */
static void out4bytes(struct uzlib_comp *out, unsigned char st, unsigned char nd, unsigned char rd,
		      unsigned char th)
{
...
#ifdef MZ_ZLIB_CHECKSUM
		out4bytes(ustate, (adler_v >> 24) & 0xFF, (adler_v >> 16) & 0xFF,
			  (adler_v >> 8) & 0xFF, adler_v & 0xFF);
#endif
