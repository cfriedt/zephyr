"""
Utility script to migrate Zephyr-based projects to new POSIX Kconfig options
...
MESSAGES = {
    ...
    "POSIX_MAX_FDS":
        "A read-only version of this symbols is POSIX_OPEN_MAX, which is of course, the standard "
