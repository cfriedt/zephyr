...
#define PCIE_EDU_IRQ_STATUS_DMA	       0x100
...
#define PCIE_EDU_DMA_CMD_START		 (PCIE_EDU_REG_DMA_CMD_START_MASK << PCIE_EDU_REG_DMA_CMD_START_SHIFT)

#define PCIE_EDU_REG_DMA_CMD_DIR_MASK  BIT_MASK(1)
#define PCIE_EDU_REG_DMA_CMD_DIR_SHIFT 1
#define PCIE_EDU_REG_DMA_CMD_DIR(dir)                                                              \
	(((dir)&PCIE_EDU_REG_DMA_CMD_DIR_MASK) << PCIE_EDU_REG_DMA_CMD_DIR_SHIFT)
#define PCIE_EDU_REG_DMA_CMD_DIR_GET(word)                                                         \
	(((word) >> PCIE_EDU_REG_DMA_CMD_DIR_SHIFT) & PCIE_EDU_REG_DMA_CMD_DIR_MASK)

#define PCIE_EDU_REG_DMA_CMD_RAISE_MASK	 BIT_MASK(1)
#define PCIE_EDU_REG_DMA_CMD_RAISE_SHIFT 2
#define PCIE_EDU_REG_DMA_CMD_RAISE                                                                 \
	(PCIE_EDU_REG_DMA_CMD_RAISE_MASK << PCIE_EDU_REG_DMA_CMD_RAISE_SHIFT)
