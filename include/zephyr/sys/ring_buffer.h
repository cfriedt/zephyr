 ...
 */
#define RING_BUF_ITEM_DECLARE(name, size32) RING_BUF_DECLARE_COMMON(name, (size32) * sizeof(uint32_t))
 ...
 * @param size32 Size of ring buffer (in 32-bit words).
 */
#define RING_BUF_ITEM_DECLARE_STATIC(name, size32) RING_BUF_DECLARE_COMMON(name, (size32) * sizeof(uint32_t), static)
