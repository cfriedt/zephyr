...
/* Sv39 canonical VA (bit 38 clear); arm64 test uses 0x456560000. */
#define TEST_VIRT_ADDR 0x056560000ULL
...
static int mem_map_test(uintptr_t virt_addr, uintptr_t phys_addr, size_t size)
{
	...
	return initial_nb_free_tables - mapped_nb_free_tables;
}
...
ZTEST_SUITE(riscv_mmu, NULL, setup, NULL, NULL, NULL);
