...
#if defined(CONFIG_TIMER_DELAYTIMER_MAX) && CONFIG_TIMER_DELAYTIMER_MAX > 0
__WARN("CONFIG_TIMER_DELAYTIMER_MAX is deprecated. Use CONFIG_POSIX_DELAYTIMER_MAX instead.");
#endif
