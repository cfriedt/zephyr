...
#ifdef CONFIG_POSIX_DEVICEIO_ALIAS_CLOSE
...
#ifdef CONFIG_POSIX_DEVICEIO_ALIAS_OPEN
...
#ifdef CONFIG_POSIX_DEVICEIO_ALIAS_READ
...
#ifdef CONFIG_POSIX_DEVICEIO_ALIAS_WRITE
